...
export default function Footer() {
  return (
<footer className="px-4 divide-y dark:bg-gray-800 dark:text-gray-100 border-t-2 border-b-slate-500 ">
		...
		<div className="lg:w-1/3">
			<Link rel="noopener noreferrer" href="#" className=" justify-center space-x-3 lg:justify-start">
				<div className="flex items-center justify-center w-60 h-20 mb-8 rounded-full dark:bg-violet-400">
					<img src="/images/brand/easygorooms-logo.png" alt="" />
				</div>
			</Link>
			...
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					<li>
						...
						<Link rel="noopener noreferrer" href="/about">About Us</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="/contact">Contact Us</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="/blogs">Blogs</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="/hotels">Hotels</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="/privacy">Privacy Policy</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="/toc">Terms of Service</Link>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
				...
				<ul className="space-y-1">
					<li>
						<Link rel="noopener noreferrer" href="/services">Sevices</Link>
					</li>
					<li>
						<Link rel="noopener noreferrer" href="/pms">PMS</Link>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
